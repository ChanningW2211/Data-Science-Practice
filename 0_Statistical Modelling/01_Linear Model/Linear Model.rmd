...
We can conclude that we need height or weight, but when one is present, the other provide little addtional information (there's probably some correlation between two variables)
